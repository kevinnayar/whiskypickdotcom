          ...
          <div className="flex flex-col justify-center">
            ...
            <div className="mt-12 grid grid-cols-3 gap-8 border-t border-background/20 pt-12">
              <div>
                ...
                <p className="mt-1 font-sans text-xs uppercase tracking-widest text-background/60">Subscribers</p>
              </div>
              <div>
                <p className="font-serif text-4xl font-bold">500+</p>
                <p className="mt-1 font-sans text-xs uppercase tracking-widest text-background/60">Reviews</p>
              </div>
              <div>
                <p className="font-serif text-4xl font-bold">8</p>
                <p className="mt-1 font-sans text-xs uppercase tracking-widest text-background/60">Years</p>
              </div>
            </div>
          </div>
        </div>
